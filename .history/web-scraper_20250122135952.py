...
# Assuming `html_content` contains the HTML text retrieved from the website
html_content = """<!doctype html> ... """  # Replace this with the full HTML response.

# Parse the HTML
soup = BeautifulSoup(html_content, 'html.parser')

# Find all text related to "Dogecoin"
results = soup.find_all(string=lambda text: "Dogecoin" in text)
...
if results:
    ...
    print("Dogecoin not found in the HTML.")
